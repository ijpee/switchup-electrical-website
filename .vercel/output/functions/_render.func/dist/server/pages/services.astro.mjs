...
const Service1 = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M92.5 89.8347H89.5322V92.8025H92.5V89.8347Z", fill: "#CDA274" }),
  ...
  const services = [
    {
      ...
      text: "Professional installation of all major EV charger brands including Tesla, Zappi, and more. Smart connectivity and load management options available."
    },
    {
      title: "Pool & Spa Electrical",
      text: "Complete electrical solutions for pools, spas, and saunas. Heating systems, pumps, lighting, and safety compliance all handled expertly."
    },
    {
      title: "Smart Home Systems",
      text: "Transform your home with intelligent lighting, automated controls, and integrated IoT systems. Modern living made effortless."
    },
    {
      title: "Switchboard Upgrades",
      text: "Modernize your electrical panel for safety and capacity. Essential for adding new circuits, EV chargers, or upgrading older homes."
    },
    {
      title: "Commercial Electrical",
      text: "Shop fit-outs, office lighting, data infrastructure, and maintenance contracts. Professional service for Auckland businesses."
    },
    {
      title: "New Builds & Renovations",
      text: "Complete electrical design and installation for new construction and major renovations. From concept to final inspection."
    }
  ];
  const howWeWorkDetails = [
    {
      ...
      info: "We start with a thorough assessment of your needs. Whether it's an EV charger, pool electrical, or smart home system, we provide detailed quotes and expert recommendations tailored to your project."
    },
    {
      imgIcon: Service2,
      numIcon: Two,
      ...
      info: "Our team creates a comprehensive electrical plan that meets all safety codes and your specific requirements. We handle permits, compliance, and coordinate with other trades if needed."
    },
    {
      imgIcon: Service3,
      numIcon: Three,
      ...
      info: "Licensed electricians execute the work with precision and care. We use quality materials, follow best practices, and keep your property clean and tidy throughout the installation process."
    },
    {
      imgIcon: Service4,
      numIcon: Four,
      ...
      info: "Every installation undergoes rigorous testing and certification. We provide all necessary documentation, warranties, and a full walkthrough to ensure you're confident with your new electrical system."
    }
  ];
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Our Services - Switchup Electrical | EV Chargers, Smart Homes, Pool Electrical", "data-astro-cid-ucd2ps2b": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="w-full bg-services h-[50vh] flex justify-center items-end" data-astro-cid-ucd2ps2b> <div class="py-[30px] lg:py-[41px] px-[60px] lg:px-[152px] flex flex-col justify-center items-center bg-white rounded-tl-[37px] rounded-tr-[37px] gap-2.5" data-astro-cid-ucd2ps2b> <h1 class="text-[30px] leading-[40px] lg:text-[50px] lg:leading-[62px] font-heading font-bold capitalize text-text-primary " data-astro-cid-ucd2ps2b>Our Services</h1> <p class="text-base lg:text-lg lg:leading-[33px] tracking-tight font-montserrat text-text-secondary" data-astro-cid-ucd2ps2b> <a href="/" class="hover:text-primary-200" data-astro-cid-ucd2ps2b>Home</a> / Services </p> </div> </section>  <section class="lg:max-w-[1200px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 lg:gap-y-12 px-12 xl:px-0 w-full mx-auto pt-[100px] lg:pt-[200px] justify-between " data-astro-cid-ucd2ps2b> ${services.map((service) => {
    return renderTemplate`<div class="w-full col-span-1 max-w-[358px] mx-auto flex rounded-[30px] hover:bg-gray-50 hover:shadow-lg transition-all duration-300 px-5 py-[83px] flex-col justify-center items-center gap-3 md:gap-5" data-astro-cid-ucd2ps2b> <h3 class="text-text-primary font-heading font-bold text-[22px] md:text-[25px] leading-loose" data-astro-cid-ucd2ps2b>${service.title}</h3> <p class="text-base md:text-lg tracking-tight font-montserrat text-text-secondary leading-[33px] text-center" data-astro-cid-ucd2ps2b> ${service.text}</p> </div>`;
  })} </section>  <section class="px-12 xl:px-0 w-full mt-[100px] lg:mt-[200px] min-h-screen " data-astro-cid-ucd2ps2b> <div class="w-full lg:max-w-[1200px] p-12 mx-auto lg:px-[116px] lg:py-[160px] bg-gray-50 rounded-[70px] " data-astro-cid-ucd2ps2b> <h2 class="font-heading font-bold tracking-wide text-center leading-[37px] lg:leading-[62.50px] text-[30px] lg:text-[50px] w-full capitalize lg:max-w-[60%] pb-2 mx-auto text-text-primary" data-astro-cid-ucd2ps2b>Our Process</h2> <p class="text-base md:text-lg text-center tracking-tight font-montserrat text-text-secondary leading-[33px] lg:max-w-[70%] mx-auto" data-astro-cid-ucd2ps2b>From initial consultation to final certification, we ensure every project is completed to the highest standards with clear communication every step of the way.</p> <div class="pt-[70px] lg:pt-[100px] flex flex-col gap-[70px] " data-astro-cid-ucd2ps2b> <!-- Inner Sections --> ${howWeWorkDetails.map((detail, index) => {
