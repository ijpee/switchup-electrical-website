  ...
  return (
    <div className="flex w-full max-w-full lg:max-w-[80%]">
      ...
      <div className="flex flex-col w-full items-center justify-center gap-4 lg:gap-8 lg:mx-[-30px]">
        <Quote />
        <h4 className="text-[20px] leading-[33px] lg:text-[35px] lg:leading-[43.75px] italic tracking-wide font-heading font-bold text-text-primary text-center">
          {text}
        </h4>
        <p className="text-text-secondary text-base tracking-tight lg:text-xl font-montserrat lg:leading-[37px] text-center ">
          {" "}
          {`— ${name}`}{" "}
        </p>
      </div>
