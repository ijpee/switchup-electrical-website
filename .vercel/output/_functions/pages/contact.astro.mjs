...
import { B as Button } from '../chunks/button_BnqymB8d.mjs';
/* empty css                                   */
...
const Mail = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "26", cy: "26", r: "26", fill: "white" }),
...
const ContactInfo = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 bg-gray-50 rounded-[30px] px-8 py-[76px] flex flex-col gap-[30px] w-full shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:admin@switchupelectrical.co.nz", className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight hover:text-primary-200 transition-colors", children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, {}),
      " admin@switchupelectrical.co.nz"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:0211396512", className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight hover:text-primary-200 transition-colors", children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, {}),
      " 0211396512"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight text-text-secondary", children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Web, {}),
...
const ContactForm = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-1 lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { action: "https://formspree.io/f/xdkwzbkl", method: "POST", className: "w-full grid grid-cols-2 gap-x-10 gap-y-[50px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "name", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
        name: "name",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "email",
        name: "email",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "subject", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
        name: "subject",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "phone", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "tel",
        name: "phone",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex justify-end col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: "Send Message", type: "submit" }) })
  ] }) });
};

const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Contact Us - Switchup Electrical | Get a Free Quote | 0211396512", "data-astro-cid-uw5kdbxl": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="w-full bg-contact h-[50vh] flex justify-center items-end" data-astro-cid-uw5kdbxl> <div class="py-[30px] lg:py-[41px] px-[60px] lg:px-[152px] flex flex-col justify-center items-center bg-white rounded-tl-[37px] rounded-tr-[37px] gap-2.5" data-astro-cid-uw5kdbxl> <h1 class="text-[30px] leading-[40px] lg:text-[50px] lg:leading-[62px] font-heading font-bold capitalize text-text-primary " data-astro-cid-uw5kdbxl>Contact Us</h1> <p class="text-base lg:text-lg lg:leading-[33px] tracking-tight font-montserrat text-text-secondary" data-astro-cid-uw5kdbxl> <a href="/" class="hover:text-primary-200" data-astro-cid-uw5kdbxl>Home</a> / Contact</p> </div> </section>  <section class="lg:max-w-[1200px] flex flex-col gap-8 lg:gap-10 px-12 xl:px-0 w-full mx-auto pt-[100px] lg:pt-[200px]" data-astro-cid-uw5kdbxl> <h2 class="text-[30px] text-center font-heading font-bold tracking-wide lg:max-w-[70%] leading-8 md:leading-[62.50px] md:text-[50px] mx-auto text-text-primary " data-astro-cid-uw5kdbxl>Ready to power your next project? Get in touch today.</h2> <!-- main section --> <div class="grid grid-cols-1 gap-[55px] pt-20 lg:grid-cols-3 place-content-center" data-astro-cid-uw5kdbxl> ${renderComponent($$result2, "ContactInfo", ContactInfo, { "data-astro-cid-uw5kdbxl": true })} ${renderComponent($$result2, "ContactForm", ContactForm, { "data-astro-cid-uw5kdbxl": true })} </div> </section> ` })} `;
}, "C:/projects/switchup-electrical/src/pages/contact.astro", void 0);

const $$file = "C:/projects/switchup-electrical/src/pages/contact.astro";
const $$url = "/contact";
