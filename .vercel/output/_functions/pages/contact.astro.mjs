...
import 'react';
import { B as Button } from '../chunks/button_iZApwJhV.mjs';
/* empty css                                   */
...
const ContactInfo = () => {
  return /* @__PURE__ */ jsxs("div", { className: "col-span-1 bg-gray-50 rounded-[30px] px-8 py-[76px] flex flex-col gap-[30px] w-full shadow-lg", children: [
    /* @__PURE__ */ jsxs("a", { href: "mailto:admin@switchupelectrical.co.nz", className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight hover:text-primary-200 transition-colors", children: [
      " ",
      /* @__PURE__ */ jsx(Mail, {}),
      " admin@switchupelectrical.co.nz"
    ] }),
    /* @__PURE__ */ jsxs("a", { href: "tel:0211396512", className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight hover:text-primary-200 transition-colors", children: [
      " ",
      /* @__PURE__ */ jsx(Phone, {}),
      " 0211396512"
    ] }),
    /* @__PURE__ */ jsxs("h5", { className: "flex flex-col xl:flex-row gap-4 items-center text-xl font-montserrat tracking-tight text-text-secondary", children: [
      " ",
      /* @__PURE__ */ jsx(Web, {}),
...
const ContactForm = () => {
  return /* @__PURE__ */ jsx("div", { className: "col-span-1 lg:col-span-2", children: /* @__PURE__ */ jsxs("form", { action: "https://formspree.io/f/xdkwzbkl", method: "POST", className: "w-full grid grid-cols-2 gap-x-10 gap-y-[50px]", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full flex justify-end col-span-2", children: /* @__PURE__ */ jsx(Button, { text: "Send Message", type: "submit" }) })
  ] }) });
};
